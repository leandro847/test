...
public class MainFrame extends javax.swing.JFrame {
    ...
    public JPanel tabBars, profile, login, mail, editAppointment, addAppointment, doctors;
    ...
    private void setupComponents() {
        ...
        profile = new ProfilePanel(this::showCard, user);
        ...
        mainPanel.add(tabBars, "tab bars page");
        mainPanel.add(login, "login");
        mainPanel.add(mail, "mail");
        mainPanel.add(editAppointment, "edit appointment");
        mainPanel.add(addAppointment, "add appointment");
