...
public class TabBarsPage extends javax.swing.JFrame {
    ...
    public void refreshAptsPage(){
        this.refreshAptsTable();
        this.refreshUpcomingAptTextArea();
    }
    
    public int getSelectedAptIndex(){
    ...
    */
    ...
    private void editAppointmentButtonActionPerformed() {                                                      
        try{
            int selectedRow = appointmentsTable.getSelectedRow();
            if (selectedRow != -1) {
                EditAppointment edit = new EditAppointment(this, appointmentDataSource, this.getSelectedAptIndex());
                edit.setDataFields();
        ...
        try{
            ...
            if (selectedRow != -1) {
                ...
                if(edit.isConfirmed()){
                    ...
                    docList.replaceDoctorInList(selectedRow, newDoctor);
                    this.refreshDocPage();
                }
